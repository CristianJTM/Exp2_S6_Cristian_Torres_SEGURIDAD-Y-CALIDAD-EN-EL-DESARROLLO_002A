    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/adoptions").authenticated()
                        .requestMatchers(HttpMethod.GET, "/adoptions/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/adoptions").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/adoptions/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/adoptions/**").authenticated()
